...
const translations = {
    ko: {
        ...
        feature_education_desc: "IG-Station, EZ-Cat, Cam350, AutoCAD 등 전문 교육",
    ...
    ja: {
        ...
        nav_about: "会社紹介",
        nav_services: "サービス",
        nav_jig_gallery: "JIGギャラリー", 
        nav_portfolio: "ポートフォリオ",
        nav_technology: "技術力",
        nav_contact: "お問い合わせ",
        
        // メインセクション
        hero_title: "専門家チームによるJIG設計革新",
        hero_subtitle: "半導体PCB JIG設計分野の専門家が創り出す<br>革新的な技術ソリューションと差別化されたサービス",
        hero_btn_contact: "お問い合わせ",
        hero_btn_portfolio: "プロジェクトを見る",
        hero_stat_years: "年の経験",
        hero_stat_projects: "プロジェクト",
        hero_stat_mems: "世界初<br>MEMS JIG開発",
        
        // 会社紹介セクション
        about_title: "I.B.S 紹介",
        about_subtitle: "InnoBridge SOLUTION - 革新的な技術ソリューションパートナー",
        about_main_title: "専門家チームとの技術革新",
        about_description: "I.B.S(InnoBridge SOLUTION)は半導体PCB JIG設計分野の専門企業です。水原に本社を置く革新的な技術ソリューション会社として、経験豊富な専門家チームがお客様に最適なソリューションを提供します。",
        
        feature_probe_title: "半導体テストワイヤプローブJIG", 
        feature_probe_desc: "仕様、ガーバー、設計から完成品まで Wire Probe JIG ワンストップサービス",
        feature_mems_title: "MEMS JIG開発",
        feature_mems_desc: "世界初電気検査MEMS JIG開発経験",
        ...
        feature_education_desc: "IG-Station、EZ-Cat、Cam350、AutoCADなど専門教育",
        
        ceo_intro_title: "代表取締役紹介",
        ceo_name: "イ・ジュンロ代表取締役",
        ceo_position: "CEO（最高経営責任者）",
        ceo_experience: "20年JIG設計経験",
        ceo_education: "公州師範大学校英文学科",
        ceo_expertise: "Wire Probe JIG、MEMS JIG専門家",
        
        // サービスセクション
        services_title: "専門サービス",
        services_subtitle: "お客様の技術向上のためのカスタマイズソリューション",
        
        service_design_title: "JIG設計・完成品製作",
        ...
        portfolio_subtitle: "革新的なJIG設計プロジェクト",
        ...
        contact_subtitle: "I.B.Sと一緒に技術革新を始めましょう",
        ...
        contact_direct_title: "直接連絡（迅速対応）",
    ...
    zh: {
        ...
        feature_education_desc: "IG-Station、EZ-Cat、Cam350、AutoCAD等专业教育",
